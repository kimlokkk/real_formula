...
class TeamData {
  ...
  static List<Team> getMidfieldTeams() {
    return teams.where((team) => team.carPerformance >= 80 && team.carPerformance < 90).toList();
  }
  ...
  static Map<String, dynamic> getTeamStatistics() {
    ...
    return {
      ...
      'averagePerformance': teams.fold(0, (sum, team) => sum + team.carPerformance) / teams.length,
      'averageReliability': teams.fold(0, (sum, team) => sum + team.reliability) / teams.length,
